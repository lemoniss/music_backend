...
var user_file_entity_1 = require("../entity/user_file.entity");
var file_entity_1 = require("../entity/file.entity");
var UserFileRepository = /** @class */ (function (_super) {
    __extends(UserFileRepository, _super);
    function UserFileRepository() {
     ...
     * @param updateUserDto
     */
    UserFileRepository.prototype.createUserFile = function (id, updateUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var userEntity, fileEntity, e_1;
    ...
    UserFileRepository = __decorate([
        (0, typeorm_1.EntityRepository)(user_file_entity_1.UserFileEntity)
    ], UserFileRepository);
