...
export class FileEntity extends BaseEntity {
  ...
  @OneToMany(() => ShowtimeFileEntity, showtimeFileEntity => showtimeFileEntity.fileEntity)
  ...
  @OneToMany(() => BannerFileEntity, bannerFileEntity => bannerFileEntity.fileEntity)
  bannerFileEntity: BannerFileEntity[];

  @OneToMany(() => ShowtimeMovieEntity, showtimeMovieEntity => showtimeMovieEntity.fileEntity)
