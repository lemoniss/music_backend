...
export class GenreEntity extends BaseEntity {
  ...
  @OneToMany(() => ShowtimeGenreEntity, showtimeGenreEntity => showtimeGenreEntity.genreEntity)
  showtimeGenreEntity: ShowtimeGenreEntity[];

  @OneToMany(() => NftMusicGenreEntity, nftMusicGenreEntity => nftMusicGenreEntity.genreEntity)
