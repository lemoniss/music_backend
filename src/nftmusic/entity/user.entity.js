...
var UserEntity = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return user_nftmusic_entity_1.UserNftMusicEntity; }, function (userNftMusicEntity) { return userNftMusicEntity.userEntity; })
    ], UserEntity.prototype, "userNftMusicEntity");
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return nftmusic_like_entity_1.NftMusicLikeEntity; }, function (nftMusicLikeEntity) { return nftMusicLikeEntity.userEntity; })
    ], UserEntity.prototype, "nftMusicLikeEntity");
